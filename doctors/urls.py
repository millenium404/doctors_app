...
from .views import doctor_edit_view, doctor_list_view, doctor_detail_view, doctor_search_view, schedule_view, htmx_calendar_view, schedule_calendar_htmx, get_appointment_htmx
